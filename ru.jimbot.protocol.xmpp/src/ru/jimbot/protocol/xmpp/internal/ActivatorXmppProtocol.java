package ru.jimbot.protocol.xmpp.internal;
...
import ru.jimbot.protocol.xmpp.XmppProtocolManager;
 ...
 *
 */
public class ActivatorXmppProtocol implements BundleActivator {
	private static EventAdmin eventAdmin;
	private static Map<EventHandler,ServiceRegistration> eventHandlers = 
		new HashMap<EventHandler,ServiceRegistration>(2);
	...
	public void start(BundleContext bundleContext) throws Exception {
		ActivatorXmppProtocol.context = bundleContext;
...
//		eventAdmin = (EventAdmin) serviceTracker.getService();
		extendsServiceTracker = new ServiceTracker(context, ExtendPointRegistry.class.getName(), null) {
			...
			public Object addingService(ServiceReference reference) {
				...
				reg.addExtend(new XmppProtocolManager());
				return service;
			}
	...
	public void stop(BundleContext bundleContext) throws Exception {
		ActivatorXmppProtocol.context = null;
