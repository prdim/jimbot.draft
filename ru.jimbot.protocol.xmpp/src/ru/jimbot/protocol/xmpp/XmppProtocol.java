 ...
 *
 */
public class XmppProtocol extends Destroyable implements Protocol, ProtocolCommandListener, OutgoingMessageListener,
        MessageListener,ChatManagerListener{
	private Log logger = ActivatorXmppProtocol.getExtendPointRegistry().getLogger();
...
//		};
	...
	this.status = id;
        ...
        Presence presence = new Presence(type, xstatustxt, 30, mode);
	...
	public void setConnectionData(String server, int port, String sn,
		...
		h1 = new OutgoingMessageEventHandler(screenName, this);
		h2 = new ProtocolCommandEventHandler(screenName, this);
		ActivatorXmppProtocol.regEventHandler(h1, h1.getHandlerServiceProperties());
		ActivatorXmppProtocol.regEventHandler(h2, h2.getHandlerServiceProperties());
	}
