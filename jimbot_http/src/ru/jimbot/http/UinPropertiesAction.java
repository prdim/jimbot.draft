...
public class UinPropertiesAction extends MainPageServletActions {
    public String perform(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (save == null) {
            ...
            print(response, "<P>Добавить новый: ");
            for(String c : Manager.getInstance().getAllProtocolManagers().keySet()) {
            	print(response, "<A HREF=\"?page=srvs_props_uin&cmd=add&save=1&ns=" + ns + "&type=" + c +
            			"\">" + c + "</A>; ");
            }
            print(response, "<br>");
...
//                    "Добавить новый UIN</A><br>");
            ...
            if ("save".equals(cmd)) {
                ...
                Manager.getInstance().getService(ns).getConfig().addUin("111", "pass", request.getParameter("type"));
                //TODO Разобраться
