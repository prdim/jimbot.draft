package ru.jimbot.protocol.icq.internal;
...
import ru.jimbot.protocol.icq.IcqProtocolManager;

public class ActivatorIcqProtocol implements BundleActivator {
	...
	public void start(BundleContext bundleContext) throws Exception {
		ActivatorIcqProtocol.context = bundleContext;
...
//		eventAdmin = (EventAdmin) serviceTracker.getService();
		extendsServiceTracker = new ServiceTracker(context, ExtendPointRegistry.class.getName(), null) {
			...
			public Object addingService(ServiceReference reference) {
				...
				reg.addExtend(new IcqProtocolManager());
				return service;
			}
	...
	public void stop(BundleContext bundleContext) throws Exception {
		ActivatorIcqProtocol.context = null;
