 ...
 */
public class IcqProtocolManager implements IProtocolManager {
	private HashMap<String, IcqProtocol> protocols = new HashMap<String, IcqProtocol>();
	
	public IcqProtocolManager() {
	...
	public IcqProtocol getProtocol(String sn) {
	...
	class Builder implements IProtocolBuilder {
		...
		public IcqProtocol build() {
			IcqProtocol p = new IcqProtocol();
